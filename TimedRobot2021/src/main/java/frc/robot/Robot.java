...
public class Robot extends TimedRobot {
  ...
  private final WPI_TalonFX m_leftSlave = new WPI_TalonFX(2);
  private final WPI_TalonFX m_rightSlave = new WPI_TalonFX(4);
  ...
  public void teleopPeriodic() {
    m_diffDrive.arcadeDrive(-m_driverController.getY(Hand.kLeft), m_driverController.getX(Hand.kRight));
  }
